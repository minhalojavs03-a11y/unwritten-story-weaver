  ...
  public: {
    Tables: {
      ...
      appointments: {
        ...
        Relationships: [
          {
            foreignKeyName: "appointments_consultant_member_id_fkey"
            columns: ["consultant_member_id"]
            isOneToOne: false
      ...
      instance_charges: {
        ...
        Relationships: [
          {
            foreignKeyName: "instance_charges_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "instance_charges_whatsapp_instance_id_fkey"
            columns: ["whatsapp_instance_id"]
            isOneToOne: false
            referencedRelation: "whatsapp_instances"
            referencedColumns: ["id"]
      ...
      meeting_recordings: {
        ...
        Relationships: [
          {
            foreignKeyName: "meeting_recordings_appointment_id_fkey"
          ...
          {
            foreignKeyName: "meeting_recordings_consultant_member_id_fkey"
            columns: ["consultant_member_id"]
            isOneToOne: false
            referencedRelation: "tenant_members"
            referencedColumns: ["id"]
      ...
      recording_views: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "recording_views_viewer_member_id_fkey"
      ...
      sheet_imported_rows: {
        ...
        Relationships: [
          {
            foreignKeyName: "sheet_imported_rows_sheet_sync_config_id_fkey"
            columns: ["sheet_sync_config_id"]
            isOneToOne: false
            referencedRelation: "sheet_sync_config"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      sheet_sync_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "sheet_sync_logs_sheet_sync_config_id_fkey"
            columns: ["sheet_sync_config_id"]
            isOneToOne: false
            referencedRelation: "sheet_sync_config"
            referencedColumns: ["id"]
      ...
      whatsapp_silence: {
        ...
        Relationships: [
          {
            foreignKeyName: "whatsapp_silence_whatsapp_instance_id_fkey"
            columns: ["whatsapp_instance_id"]
            isOneToOne: false
            referencedRelation: "whatsapp_instances"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      bootstrap_first_superadmin: { Args: never; Returns: boolean }
      canonical_br_phone: { Args: { p: string }; Returns: string }
      ...
      gamification_get_config: {
        ...
        SetofOptions: {
          from: "*"
          to: "gamification_config"
          isOneToOne: true
          isSetofReturn: false
        }
      }
      gamification_log_event: {
        Args: {
      ...
      parse_credit_from_interest: { Args: { _raw: string }; Returns: number }
      release_lead: {
        Args: { _lead_id: string; _member_id: string }
        Returns: undefined
      }
      set_ai_pre_attendance: { Args: { _enabled: boolean }; Returns: undefined }
