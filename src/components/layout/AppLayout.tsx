    ...
    <div className={cn(
      ...
      <main className={cn(
        ...
        <header className={cn(
          ...
          isConversasMobile && "hidden md:flex md:absolute md:top-0 md:right-0 md:left-auto md:h-12 md:w-auto md:bg-transparent md:pointer-events-none md:[&>*]:pointer-events-auto",
        )}>
