...
export default function AdminLoginPage() {
  ...
  return (
    <main className="grid min-h-screen bg-[hsl(224_64%_6%)] text-white lg:grid-cols-2">
      <aside className="relative h-56 overflow-hidden sm:h-72 lg:order-last lg:h-auto">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[hsl(224_64%_6%)] via-[hsl(224_64%_6%)]/40 to-transparent lg:bg-gradient-to-l lg:from-transparent lg:via-transparent lg:to-[hsl(224_64%_6%)]" />
        <div className="absolute inset-0 bg-gradient-to-tr from-[hsl(217_91%_50%)]/20 via-transparent to-transparent" />
      ...
      <section className="relative flex items-center justify-center overflow-hidden p-6 sm:p-10 lg:p-16">
        <div className="pointer-events-none absolute -left-32 top-1/3 h-96 w-96 rounded-full bg-[hsl(217_91%_60%)]/15 blur-3xl" />
        <div className="pointer-events-none absolute -right-32 bottom-1/4 h-96 w-96 rounded-full bg-[hsl(217_91%_60%)]/10 blur-3xl" />
        ...
        <div className="relative z-10 w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input id="admin-email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="admin@consorciofera.com.br" required className="h-11 border-white/15 bg-white/5 text-white placeholder:text-white/40" />
            </div>
            <div className="space-y-1.5">
              <Label htmlFor="admin-password" className="text-white/80">Senha</Label>
              <Input id="admin-password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} minLength={6} required className="h-11 border-white/15 bg-white/5 text-white" />
            </div>
            <Button type="submit" className="h-11 w-full bg-gradient-to-r from-[hsl(217_91%_60%)] to-[hsl(217_91%_45%)] text-white shadow-lg shadow-[hsl(217_91%_60%)]/40 hover:opacity-95" disabled={loading}>
