...
import { Smartphone, AlertCircle, CheckCircle2, ArrowRight, KeyRound } from "lucide-react";
...
export default function ConfiguracoesPage() {
  ...
  return (
    <>
      ...
      <div className="space-y-4 p-3 md:max-w-3xl md:space-y-6 md:p-8">
        ...
        <section className="rounded-xl border bg-card p-4 md:p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <Textarea rows={5} value={prompt} onChange={(e) => setPrompt(e.target.value)} disabled={!isOwner} />
            </div>
          </div>
        </section>
