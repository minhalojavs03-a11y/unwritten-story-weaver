...
BEGIN
  ...
  -- O estado do WhatsApp nunca participa da elegibilidade nem da ordenação.
  ...
  -- 2) Rotação normal, sem qualquer consulta ao WhatsApp.
  ...
  -- 3) Fallback: qualquer consultor ativo e habilitado, ignorando cota e WhatsApp.
  IF _picked IS NULL THEN
